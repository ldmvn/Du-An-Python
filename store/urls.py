...
urlpatterns = [
    ...
    path('dashboard/admin/vietqr/', views.admin_vietqr_list, name='admin_vietqr_list'),
    path('dashboard/admin/vietqr/approve/<int:qr_id>/', views.admin_approve_vietqr, name='admin_approve_vietqr'),
    path('dashboard/admin/vietqr/cancel/<int:qr_id>/', views.admin_cancel_vietqr, name='admin_cancel_vietqr'),
    path('dashboard/admin/media/', views.admin_media_library, name='admin_media_library'),
    path('dashboard/admin/media/add/', views.admin_media_add, name='admin_media_add'),
    path('dashboard/admin/specifications/', views.admin_specifications, name='admin_specifications'),
    path('dashboard/admin/specifications/add/', views.admin_spec_add, name='admin_spec_add'),
    path('dashboard/admin/vouchers/', views.admin_vouchers, name='admin_vouchers'),
    path('dashboard/admin/vouchers/add/', views.voucher_create, name='voucher_create'),
    path('dashboard/admin/vouchers/edit/<int:pk>/', views.voucher_edit, name='voucher_edit'),
    path('dashboard/admin/vouchers/delete/<int:pk>/', views.voucher_delete, name='voucher_delete'),
    ...
    path('ajax/cart/update-option/', views.update_cart_option_ajax, name='update_cart_option_ajax'),
    path('ajax/cart/remove/', views.remove_from_cart_ajax, name='remove_from_cart_ajax'),
    path('ajax/voucher/validate/', views.validate_voucher, name='validate_voucher'),
    path('checkout/', views.checkout, name='checkout'),
    path('checkout/cart/', views.checkout_from_cart, name='checkout_from_cart'),
    path('checkout/vietqr/', views.vietqr_page, name='vietqr_page'),
    path('checkout/vietqr/status/', views.vietqr_page_status, name='vietqr_status'),
    path('checkout/vietqr/expire/', views.vietqr_page_expire, name='vietqr_expire'),
    ...
    path('order-tracking/received/<int:order_id>/', views.confirm_received_order, name='confirm_received_order'),
    path('order-tracking/buy-again/<int:order_id>/', views.buy_again_order, name='buy_again_order'),
